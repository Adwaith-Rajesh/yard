...
void register_commands(YardMasterCtx *mctx) {
    ...
    map_set(mctx->_commands, "getz", CMD_DC_FROM_MCTX(mctx, getz_wrap));
    map_set(mctx->_commands, "setz", CMD_DC_FROM_MCTX(mctx, setz_wrap));
    map_set(mctx->_commands, "delz", CMD_DC_FROM_MCTX(mctx, delz_wrap));
}
